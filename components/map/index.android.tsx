...
import GeoShapes, { PolygonCollection } from "./geoShapes.android";
...
const SHAPE_SOURCE: GeoJSON.Feature = {
  geometry: {
    coordinates: [-58.01431214504318, -31.32326296856089],
    type: "Point",
  },
  properties: {},
  type: "Feature",
...
const Map = () => {
  ...
  const [polygonPoint, setPolygonPoint] = useState<POINTS>([]);
  const [polygonTurf, setPolygonTurf] = useState<GeoJSON.Feature | null>(null);
  ...
  return (
    <View>
      ...
      >
        ...
        {!!polygonPoint.length && <PolygonCollection points={polygonPoint} />}
      </Mapbox.MapView>
    </View>
  );
};
